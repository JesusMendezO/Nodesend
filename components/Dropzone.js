...
const Dropzone = () => {
       ...
       //acceder al context de autenticacion
    ...
    const archivos = acceptedFiles.map( archivo => (
        <li key={archivo.lastModified}  className="bg-white flex-1 p3 mb-4 shadow-lg rounded">
            ...
            { acceptedFiles.length > 0 ? (
                ...
                <h4 className="text-2xl font-bold text-center mb-4">Archivos</h4>
                 ...
                 </ul>
                 {
                  ...
                  {cargando ? <p className="my-10 text-center text-gray-600">Subiendo Archivo...</p> :  <button
                   type="button"
